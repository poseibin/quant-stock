...
function LimitSignalEvaluationPanel() {
  ...
  return (
    <section className="dashboardPanel limitEvaluationPanel">
      <div className="tableHeader">
        <div>
          <div className="sectionLabel">SELF EVOLUTION</div>
          <div className="dashboardPanelTitle">策略回看验证</div>
      ...
      <div className="limitEvaluationGrid">
        {items.length === 0 ? (
          <div className="taskGridEmpty">暂无回看结果，先刷新推荐/预警后点击评估验证</div>
        ) : items.map((item) => (
