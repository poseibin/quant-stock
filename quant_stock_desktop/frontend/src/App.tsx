...
import { Activity, Database, Flame, ListChecks, Search, Settings as SettingsIcon, WalletCards } from 'lucide-react'
...
type Page = 'dashboard' | 'tasks' | 'positions' | 'research' | 'breakout' | 'data' | 'settings'
