...
func tableComments() map[string]string {
	return map[string]string{
		...
		"eval_parameter_experiments":        "策略参数实验记录",
		...
		"market_limit_breakout_cache":       "涨停突破候选缓存",
		"market_limit_breakout_cache_meta":  "涨停突破缓存批次元信息",
		"market_limit_momentum_cache":       "涨停动量候选缓存",
		"market_limit_momentum_cache_meta":  "涨停动量缓存批次元信息",
		"market_limit_signal_eval_summary":  "涨停类信号评估汇总",
		"market_limit_signal_predictions":   "涨停类信号候选与事后评估",
		"monitor_policy_support_candidates": "政策支撑监控候选股票",
		"monitor_policy_support_signals":    "政策支撑市场状态信号",
...
func tableColumnComments() map[string]map[string]string {
	return map[string]map[string]string{
		...
		"market_limit_signal_eval_summary": {
			...
			"parameter_key": "参数组合键",
			"sample_count":  "已评估样本数",
			"pending_count": "待评估样本数",
			"hit_rate":      "目标命中率",
		},
		"market_limit_signal_predictions": {
			"signal_type":     "信号类型",
			"signal_price":    "信号日价格",
			"hit_limit_up_5d": "未来5日是否触及涨停",
			"target_hit":      "是否命中目标",
		},
		"rec_hindsight": {
